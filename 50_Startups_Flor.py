...
diction = {'Florida' : RegrVaria.predict([[8000000]])}
...
diction = {'NewYork' : RegrVaria.predict([[8000000]])}
...
#Determining Minimun and Maximum values in Dictionary
min_value = min(diction.values())
max_value = max(diction.values())
minimum = [s for s, t in diction.items() if v= min_value]
maximum = [s for s, t in diction.items() if v= max_value]
print("Therefore," , maximum, "would give preferred expectation than", minimum, "in future. ")